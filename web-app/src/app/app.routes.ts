...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'content/playlists', loadComponent: () => import('./features/content/playlists').then(m => m.PlaylistsComponent) },
      { path: 'playlist/smart/:key', loadComponent: () => import('./features/content/smart-playlist-detail').then(m => m.SmartPlaylistDetailComponent) },
      { path: 'playlist/:playlistId', loadComponent: () => import('./features/content/playlist-detail').then(m => m.PlaylistDetailComponent) },
      ...
      {
        path: 'admin/item/:mediaItemId',
        loadComponent: () => import('./features/admin/media-item-edit').then(m => m.MediaItemEditComponent),
        canDeactivate: [
          async (c: import('./features/admin/media-item-edit').MediaItemEditComponent) => c.canDeactivate(),
        ],
      },
