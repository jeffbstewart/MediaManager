...
data class AppUser(
    ...
    /** Returns the typed rating ceiling, or null if this user is unrestricted. */
    val ratingCeilingValue: RatingCeiling? get() = RatingCeiling.fromDb(rating_ceiling)
