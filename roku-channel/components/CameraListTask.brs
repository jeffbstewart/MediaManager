...
sub init()
    print "[MM " ; mmts() ; "] CameraListTask: init"
end sub
...
sub doFetch()
    ...
    print "[MM " ; mmts() ; "] CameraListTask: fetching " ; url
    ...
    print "[MM " ; mmts() ; "] CameraListTask: response code=" ; str(httpCode).trim() ; " size=" ; str(len(response)).trim()
    ...
    print "[MM " ; mmts() ; "] CameraListTask: parsed " ; str(json.cameras.count()).trim() ; " cameras"
