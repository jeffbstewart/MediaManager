...
struct ReadingProgressQueueEntry: Codable, Sendable, Hashable {
...
actor ReadingProgressQueue {
    static let shared = ReadingProgressQueue()
    ...
    func markFlushed(mediaItemId: Int64, asOf recordedAt: Date) {
