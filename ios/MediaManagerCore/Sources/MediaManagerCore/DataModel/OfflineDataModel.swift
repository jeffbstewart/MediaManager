...
@Observable
@MainActor
public final class OfflineDataModel: DataModel {
    ...
    public var apiClient: APIClient { onlineModel.apiClient }

    public init(onlineModel: OnlineDataModel) {
    ...
    public func deletePlaylist(id: Int64) async throws { throw DataModelError.offline }
    ...
    public func wishList() async throws -> ApiWishListResponse { throw DataModelError.offline }
    public func transcodeWishList() async throws -> ApiTranscodeWishListResponse { throw DataModelError.offline }
    ...
    public func removeBookWish(olWorkId: String) async throws { throw DataModelError.offline }
    public func addAlbumWish(releaseGroupId: String, title: String, primaryArtist: String?) async throws {
        throw DataModelError.offline
    }
    public func removeAlbumWish(releaseGroupId: String) async throws { throw DataModelError.offline }
    public func wishlistSeriesGaps(seriesId: BookSeriesID) async throws -> (added: Int, alreadyWished: Int) {
        throw DataModelError.offline
    }
    public func deleteWish(id: WishID) async throws { throw DataModelError.offline }
    public func voteOnWish(id: WishID, vote: Bool) async throws { throw DataModelError.offline }
    public func dismissWish(id: WishID) async throws { throw DataModelError.offline }
    public func deleteTranscodeWish(titleId: TitleID) async throws { throw DataModelError.offline }
    public func searchTmdb(query: String) async throws -> TmdbSearchResponse { throw DataModelError.offline }
    public func searchTmdb(query: String, type: MMMediaType) async throws -> MMTmdbSearchResponse { throw DataModelError.offline }

    // MARK: - ProfileDataModel

    public func profile() async throws -> ProfileResponse { throw DataModelError.offline }
    public func updateTvQuality(_ quality: Int) async throws { throw DataModelError.offline }
    public func changePassword(current: String, new: String) async throws { throw DataModelError.offline }
    public func sessions() async throws -> ApiSessionListResponse { throw DataModelError.offline }
    public func deleteSession(id: SessionID, type: SessionType) async throws { throw DataModelError.offline }
    public func deleteOtherSessions() async throws { throw DataModelError.offline }

    // MARK: - LiveDataModel

    public func cameras() async throws -> ApiCameraListResponse { throw DataModelError.offline }
    public func tvChannels() async throws -> ApiTvChannelListResponse { throw DataModelError.offline }
    public func warmUpStream(path: String) async throws { throw DataModelError.offline }

    // MARK: - AdminDataModel

    public func transcodeStatus() async throws -> TranscodeStatusResponse { throw DataModelError.offline }
    public func buddyStatus() async throws -> BuddyStatusResponse { throw DataModelError.offline }
    public func monitorTranscodeStatus(onUpdate: @Sendable @escaping (MMTranscodeStatusUpdate) async -> Void) async throws { throw DataModelError.offline }
    public func submitBarcode(upc: String) async throws -> MMSubmitBarcodeResponse { throw DataModelError.offline }
    public func monitorScanProgress(onUpdate: @Sendable @escaping (MMScanProgressUpdate) async -> Void) async throws { throw DataModelError.offline }
    public func getScanDetail(scanId: Int64) async throws -> MMScanDetailResponse { throw DataModelError.offline }
    public func assignTmdb(titleId: Int64, tmdbId: Int32, mediaType: MMMediaType) async throws -> MMAssignTmdbResponse { throw DataModelError.offline }
    public func searchMusicBrainz(query: String, barcode: String?) async throws -> MMSearchMusicBrainzResponse { throw DataModelError.offline }
    public func assignMusicBrainzRelease(titleId: Int64, releaseMbid: String) async throws { throw DataModelError.offline }
    public func updatePurchaseInfo(scanId: Int64, place: String?, date: MMCalendarDate?, price: Double?) async throws { throw DataModelError.offline }
    public func uploadOwnershipPhoto(scanId: Int64, photoData: Data, contentType: String) async throws -> MMUploadOwnershipPhotoResponse { throw DataModelError.offline }
    public func deleteOwnershipPhoto(photoId: String) async throws { throw DataModelError.offline }
    public func adminListCameras() async throws -> MMAdminCameraListResponse { throw DataModelError.offline }
    public func adminCreateCamera(name: String, rtspUrl: String, snapshotUrl: String, streamName: String?, enabled: Bool) async throws -> MMAdminCamera { throw DataModelError.offline }
    public func adminUpdateCamera(id: Int64, name: String, rtspUrl: String, snapshotUrl: String, streamName: String, enabled: Bool) async throws -> MMAdminCamera { throw DataModelError.offline }
    public func adminDeleteCamera(id: Int64) async throws { throw DataModelError.offline }
    public func adminReorderCameras(ids: [Int64]) async throws { throw DataModelError.offline }
    public func scanNas() async throws { throw DataModelError.offline }
    public func clearFailures() async throws { throw DataModelError.offline }
    public func adminSettings() async throws -> AdminSettingsResponse { throw DataModelError.offline }
    public func updateSetting(key: String, value: String?) async throws { throw DataModelError.offline }
    public func linkedTranscodes(page: Int) async throws -> AdminLinkedTranscodeResponse { throw DataModelError.offline }
    public func unlinkTranscode(id: TranscodeID) async throws { throw DataModelError.offline }
    public func adminTags() async throws -> ApiTagListResponse { throw DataModelError.offline }
    public func createTag(name: String, color: String) async throws { throw DataModelError.offline }
    public func updateTag(id: TagID, name: String, color: String) async throws { throw DataModelError.offline }
    public func deleteTag(id: TagID) async throws { throw DataModelError.offline }
    public func dataQuality(page: Int) async throws -> AdminDataQualityResponse { throw DataModelError.offline }
    public func reEnrich(titleId: TitleID) async throws { throw DataModelError.offline }
    public func deleteTitle(id: TitleID) async throws { throw DataModelError.offline }
    public func purchaseWishes() async throws -> AdminPurchaseWishListResponse { throw DataModelError.offline }
    public func updatePurchaseWishStatus(tmdbId: TmdbID, mediaType: MediaType, seasonNumber: Int?, status: AcquisitionStatus) async throws { throw DataModelError.offline }
    public func adminUsers() async throws -> AdminUserListResponse { throw DataModelError.offline }
    public func createUser(username: String, password: String, displayName: String?, accessLevel: Int) async throws { throw DataModelError.offline }
    public func updateUserRole(id: UserID, accessLevel: Int) async throws { throw DataModelError.offline }
    public func updateUserRatingCeiling(id: UserID, ceiling: Int?) async throws { throw DataModelError.offline }
    public func unlockUser(id: UserID) async throws { throw DataModelError.offline }
    public func forcePasswordChange(id: UserID) async throws { throw DataModelError.offline }
    public func resetPassword(id: UserID, newPassword: String) async throws { throw DataModelError.offline }
    public func deleteUser(id: UserID) async throws { throw DataModelError.offline }
    public func unmatchedFiles() async throws -> AdminUnmatchedResponse { throw DataModelError.offline }
    public func acceptUnmatched(id: UnmatchedFileID) async throws { throw DataModelError.offline }
    public func ignoreUnmatched(id: UnmatchedFileID) async throws { throw DataModelError.offline }
    public func linkUnmatched(id: UnmatchedFileID, titleId: TitleID) async throws { throw DataModelError.offline }
    public func setAuthorHidden(id: AuthorID, hidden: Bool) async throws { throw DataModelError.offline }
}
