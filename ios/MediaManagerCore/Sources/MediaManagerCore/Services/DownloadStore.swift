...
public actor DownloadStore {
    ...
    public var entries: [MMDownloadEntry] { db.entries }

    public func entry(for transcodeId: Int64) -> MMDownloadEntry? {
        db.entries.first { $0.transcodeID == transcodeId }
    }

    public func entry(bySequence seq: Int32) -> MMDownloadEntry? {
    ...
    public func addEntry(_ entry: MMDownloadEntry) -> MMDownloadEntry {
        var e = entry
    ...
    public func updateEntry(transcodeId: Int64, _ mutate: @Sendable (inout MMDownloadEntry) -> Void) {
    ...
    public func removeEntry(transcodeId: Int64) {
        guard let idx = db.entries.firstIndex(where: { $0.transcodeID == transcodeId }) else { return }
