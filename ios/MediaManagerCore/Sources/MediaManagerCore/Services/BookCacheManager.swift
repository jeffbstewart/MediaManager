...
public struct DownloadedBook: Codable, Identifiable, Sendable, Hashable {
...
public struct BookDownloadProgress: Sendable, Hashable {
    public let mediaItemId: Int64
...
public enum BookCacheError: LocalizedError {
...
public final class BookCacheManager {
    ...
    public func configure(grpcClient: GrpcClient) {
        self.grpcClient = grpcClient
    }

    // MARK: - Read API

    public func isDownloaded(_ mediaItemId: Int64) -> Bool {
    ...
    /// to call repeatedly.
    public func cacheTitleDetail(_ detail: ApiTitleDetail) {
    ...
    public func loadCachedTitleDetail(titleId: Int64) -> ApiTitleDetail? {
    ...
    public struct BulkBookStatus: Equatable {
    ...
    /// render.
    public func bulkStatus(forTitleIds ids: [Int64]) -> BulkBookStatus {
    ...
    public func bulkStatus(forMediaItems ids: [Int64]) -> BulkBookStatus {
        guard !ids.isEmpty else {
            return BulkBookStatus(total: 0, completed: 0, inFlight: 0, failed: 0)
        }
    ...
    public func localBookURL(_ mediaItemId: Int64) -> URL? {
    ...
    public func updateLastAccessed(_ mediaItemId: Int64, completedFraction: Double) {
    ...
    public func cancelDownload(_ mediaItemId: Int64) {
    ...
    /// they want.
    public func deleteDownload(_ mediaItemId: Int64) throws {
...
private final class ByteCounter: @unchecked Sendable {
    ...
    public var value: Int64 { lock.withLock { _value } }
    @discardableResult
