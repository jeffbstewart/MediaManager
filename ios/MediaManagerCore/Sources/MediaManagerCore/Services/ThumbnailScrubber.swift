...
@MainActor
public final class ThumbnailScrubber {
    ...
    public var isAvailable: Bool { !cues.isEmpty }

    /// Load the thumbs.vtt and pre-fetch sprite sheet images.
    public func load(transcodeId: Int, apiClient: APIClient, localDir: URL? = nil) async {
