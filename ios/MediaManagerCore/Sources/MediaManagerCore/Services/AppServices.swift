...
public final class AppServices {
    ...
    public private(set) var audioPlayer: AudioPlayerManager?
    public private(set) var dataModel: OnlineDataModel?
    public private(set) var audioCache: AudioCacheManager?
    ...
    public func whenReady(_ cb: @escaping () -> Void) {
        if audioPlayer != nil {
            cb()
        } else {
    ...
    public var isReady: Bool { audioPlayer != nil }
}
